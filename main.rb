...
yt_usage = "!play <youtube url> ` or a search ` !play <what to search for>"
...
bot.command([:play, :youtube, :music], usage: yt_usage, description: play_desc, min_args: 1) do |event, *songlink|
	case event.server.id
		when 203172685449134080
